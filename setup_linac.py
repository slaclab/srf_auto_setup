...
class SetupCavity(Cavity):
    ...
    def __init__(self, cavityNum, rackObject, ssaClass=SSA,
        ...
        self.progress_pv: str = self.auto_pv_addr("PROGRESS")
        self.status_severity_pv: str = self.auto_pv_addr("STATUS.SEVR")
        ...
        # TODO implement
        self.status_msg_pv: str = self.auto_pv_addr("")
        self._status_msg_pv_obj: PV = None
